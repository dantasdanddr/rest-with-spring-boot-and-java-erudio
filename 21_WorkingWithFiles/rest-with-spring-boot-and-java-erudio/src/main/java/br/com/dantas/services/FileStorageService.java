...
import br.com.dantas.config.FileStorageConfig;
import br.com.dantas.exception.FileNotFoundException;
import br.com.dantas.exception.FileStorageException;
...
public class FileStorageService {
    ...
    public Resource loadFileAsResource(String fileName) {
        logger.info("Download file as resource: {}", fileName);
        try {
